# Example: Simple Cloud Slurm Cluster with TPUs

[FAQ](../../../../../docs/faq.md) | [Glossary](../../../../../docs/glossary.md)

<!-- mdformat-toc start --slug=github --no-anchors --maxlevel=6 --minlevel=1 -->

- [Example: Simple Cloud Slurm Cluster with TPUs](#example-simple-cloud-slurm-cluster-with-tpus)
  - [Overview](#overview)
  - [Usage](#usage)
