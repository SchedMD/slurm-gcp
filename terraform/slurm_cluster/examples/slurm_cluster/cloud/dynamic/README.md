# Example: Dynamic Cloud Slurm Cluster
...
- [Example: Dynamic Cloud Slurm Cluster](#example-dynamic-cloud-slurm-cluster)
  - [Overview](#overview)
  - [Usage](#usage)
...
in cloud mode. Two dynamic compute nodes are created in the default partition.
