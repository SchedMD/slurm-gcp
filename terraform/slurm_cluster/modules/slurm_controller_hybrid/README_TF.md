...
| <a name="input_partitions"></a> [partitions](#input\_partitions) | Cluster partitions as a list. Pass list of module.slurm\_partition (e.g. partitions = [module.slurm\_partition, ]). | `list(any)` | `[]` | no |
