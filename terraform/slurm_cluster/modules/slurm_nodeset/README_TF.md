...
| <a name="input_spot_instance_config"></a> [spot\_instance\_config](#input\_spot\_instance\_config) | Configure spot VM. | <pre>object({<br>    termination_action = string<br>  })</pre> | `null` | no |
