...
| <a name="input_slurm_instance_type"></a> [slurm\_instance\_type](#input\_slurm\_instance\_type) | Slurm instance type. Must be one of: controller; login; compute. | `string` | `null` | no |
