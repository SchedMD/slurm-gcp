...
| <a name="input_compute_node_groups_defaults"></a> [compute\_node\_groups\_defaults](#input\_compute\_node\_groups\_defaults) | Defaults for compute\_node\_groups in partitions.<br><br>Default value priority order:<br>- compute\_node\_groups<br>- compute\_node\_groups\_defaults<br>- slurm\_cluster\_defaults<br><br>See 'locals.tf' for valid key/value. | `any` | `{}` | no |
...
| <a name="input_controller_instance_config"></a> [controller\_instance\_config](#input\_controller\_instance\_config) | Creates a controller instance with given configuration.<br><br>Default value priority order:<br>- controller\_instance\_config<br>- slurm\_cluster\_defaults<br><br>See 'locals.tf' for valid key/value. | `any` | `{}` | no |
...
| <a name="input_login_node_groups_defaults"></a> [login\_node\_groups\_defaults](#input\_login\_node\_groups\_defaults) | Defaults for login\_node\_groups.<br><br>Default value priority order:<br>- login\_node\_groups<br>- login\_node\_groups\_defaults<br>- slurm\_cluster\_defaults<br><br>See 'locals.tf' for valid key/value. | `any` | `{}` | no |
...
| <a name="input_partitions"></a> [partitions](#input\_partitions) | Cluster partitions as a list. See module slurm\_partition.<br><br>Default value priority order:<br>- compute\_node\_groups<br>- compute\_node\_groups\_defaults<br>- slurm\_cluster\_defaults<br><br>See 'module.slurm\_partition:main.tf' for valid key/value. | `list(any)` | `[]` | no |
...
| <a name="input_slurm_cluster_defaults"></a> [slurm\_cluster\_defaults](#input\_slurm\_cluster\_defaults) | Defaults for cluster controller, login, and compute nodes.<br><br>Controller node default value priority order:<br>- controller\_instance\_config<br>- slurm\_cluster\_defaults<br><br>Login node default value priority order:<br>- login\_node\_groups<br>- login\_node\_groups\_defaults<br>- slurm\_cluster\_defaults<br><br>Compute node default value priority order:<br>- compute\_node\_groups<br>- compute\_node\_groups\_defaults<br>- slurm\_cluster\_defaults<br><br>See 'locals.tf' for valid key/value. | `any` | `{}` | no |
