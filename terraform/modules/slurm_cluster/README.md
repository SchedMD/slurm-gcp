...
| <a name="input_jwt_key"></a> [jwt\_key](#input\_jwt\_key) | Cluster jwt authentication key.<br><br>If 'enable\_hybrid=true', this is ignored. Otherwise if 'null', a key will be<br>generated. | `string` | `null` | no |
...
| <a name="input_munge_key"></a> [munge\_key](#input\_munge\_key) | Cluster munge authentication key.<br><br>If 'enable\_hybrid=true', this is required. Otherwise if 'null', a key will be<br>generated. | `string` | `null` | no |
