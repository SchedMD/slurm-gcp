...
| Name | Type |
|------|------|
| [google_compute_instance_template.partition_template](https://registry.terraform.io/providers/hashicorp/google/latest/docs/data-sources/compute_instance_template) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_enable_job_exclusive"></a> [enable\_job\_exclusive](#input\_enable\_job\_exclusive) | Enables job exclusivity. One job to job one placement. | `bool` | `false` | no |
...
| <a name="input_partition_nodes"></a> [partition\_nodes](#input\_partition\_nodes) | Grouped nodes in the partition. | <pre>list(object({<br>    node_group_name   = string<br>    instance_template = string<br>    count_static      = number<br>    count_dynamic     = number<br>  }))</pre> | n/a | yes |
...
| <a name="input_zone_policy_allow"></a> [zone\_policy\_allow](#input\_zone\_policy\_allow) | Partition nodes will prefer to be created in the listed zones. | `list(string)` | `[]` | no |
| <a name="input_zone_policy_deny"></a> [zone\_policy\_deny](#input\_zone\_policy\_deny) | Partition nodes will not be created in the listed zones. | `list(string)` | `[]` | no |
...
| <a name="output_partition_subnetwork"></a> [partition\_subnetwork](#output\_partition\_subnetwork) | Partition subnetwork. |
| <a name="output_partition_template"></a> [partition\_template](#output\_partition\_template) | Instance templates in partition. |
