...
variable "network" {
  ...
  description = "Network configuration for cluster."
  default = {
...
variable "controller_templates" {
  ...
  description = "Maps slurm controller template name to instance definition."
  default     = {}
}
...
variable "controller_instances" {
  ...
  description = "Instantiates controller node(s) from slurm 'controller_template'."
  default     = []
}
