...
| <a name="input_config"></a> [config](#input\_config) | General cluster configuration. | <pre>object({<br>    cloudsql = object({<br>      server_ip = string<br>      user      = string<br>      password  = string # (sensitive)<br>      db_name   = string<br>    })<br>    jwt_key   = string<br>    munge_key = string<br>    serf_keys = list(string)<br><br>    ### storage ###<br>    network_storage = list(object({<br>      server_ip     = string<br>      remote_mount  = string<br>      local_mount   = string<br>      fs_type       = string<br>      mount_options = string<br>    }))<br>    login_network_storage = list(object({<br>      server_ip     = string<br>      remote_mount  = string<br>      local_mount   = string<br>      fs_type       = string<br>      mount_options = string<br>    }))<br><br>    ### slurm conf files ###<br>    cgroup_conf_tpl   = string<br>    slurm_conf_tpl    = string<br>    slurmdbd_conf_tpl = string<br><br>    ### scripts.d ###<br>    controller_d = string<br>    compute_d    = string<br>  })</pre> | <pre>{<br>  "cgroup_conf_tpl": null,<br>  "cloudsql": null,<br>  "compute_d": null,<br>  "controller_d": null,<br>  "jwt_key": null,<br>  "login_network_storage": null,<br>  "munge_key": null,<br>  "network_storage": null,<br>  "serf_keys": null,<br>  "slurm_conf_tpl": null,<br>  "slurmdbd_conf_tpl": null<br>}</pre> | no |
