# Example: Simple Slurm Login Instance

This example creates a simple slurm login instance.
...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | Cluster name. Used to name resources. | `string` | `"simple"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_slurm_login_instance"></a> [slurm\_login\_instance](#output\_slurm\_login\_instance) | Slurm login instance self\_links |
