...
See the [advanced end-2-end example](../terraform/examples/slurm_cluster/hybrid/advanced_e2e/README.md) for an all inclusive example.
...
See the [advanced example](../terraform/examples/slurm_cluster/hybrid/advanced/README.md) for a minimal example.
...
1. Deploy [advanced end-2-end example](../terraform/examples/slurm_cluster/hybrid/advanced_e2e/).

#### Minimal Configuration

1. Install software requirements.
1. Deploy [advanced example](../terraform/examples/slurm_cluster/hybrid/advanced/).
