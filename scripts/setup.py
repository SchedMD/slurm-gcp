...
def gen_cloud_conf(lkp, cloud_parameters=None):
    def confline(lkp, cloud_parameters={}):
        ...
        lines = {
            ...
            'PrologSlurmctld': f'{scripts_dir}/resume.sh',
            'EpilogSlurmctld': f'{scripts_dir}/suspend.sh',
            'SuspendProgram': f'{scripts_dir}/suspend.sh',
            'ResumeProgram': f'{scripts_dir}/resume.sh',
            'ResumeFailProgram': f'{scripts_dir}/suspend.sh',
